...
I am Philippe Miron, a Principal AI Engineer passionate about the ever-evolving world of artificial intelligence and how to automate processes and tackle complex tasks. At [Premera Blue Cross](https://www.premera.com) since Sep. 2024, our team is responsible for deploying a scalable, agent-based AI framework to support a variety of business needs, most notably a retrieval-augmented generation (RAG) system that helps Customer Service Representatives search thousands of policy documents. Over the next few months, I will be building a suite of interconnected AI agents and tools—using the Agent2Agent Protocol (A2A) and the Model Context Protocol (MCP)—and deploying them efficiently on Kubernetes (AKS).
